...
export const operationsModule: AdapterModule = {
  ...
  operations: [
    ...
    operation("content.authorDirectory", z.object({ contentItemId: uuid }), ({ supabase }, payload) => contentAuthorDirectory(supabase, payload.contentItemId)),
