...
export function InvoiceDetail({ invoiceRef, initial }: InvoiceDetailProps) {
  ...
  useEffect(() => {
    ...
    let cancelled = false;
    void familyContextService.classifyStudentAccess(context.accountId, view.studentId).then((scope) => {
          ...
          <header className={styles.pageHeader}>
            ...
            <div className={styles.headerActions}>
              ...
              <span id="invoice-print-note" className="sr-only">
                Opens the browser print dialog for the visible demo invoice details. No file is generated by this demo.
              </span>
            </div>
            <p className="sr-only" role="status" aria-live="polite">
              {printNotice}
