...
export const metadata: Metadata = {
  ...
  description:
    "Start a student admission application for session 2026-27 at Faiz Aam Secondary School — what you need, and how the application works.",
};

const DOCUMENTS = [
  { name: "Birth certificate", note: "For verifying age and identity." },
  { name: "Student photograph", note: "A recent, passport-size photograph." },
  { name: "Previous report card", note: "The most recent report card from the current school." },
  { name: "Address proof", note: "Any official document showing the family's address." },
];
        ...
        <div className={styles.overviewGrid}>
          <div>
            <p className={styles.bodyLine}>
              Applications are open for classes 6 to 10 for session 2026-27. The child must meet the age rule for
