...
const HEADER_ALIASES: Readonly<Record<string, string>> = {
  ...
  grade_section: "gradeSectionId",
  section: "gradeSectionId",
  class: "gradeSectionId",
  class_section: "gradeSectionId",
  class_label: "gradeSectionId",
...
export const CANONICAL_TARGET_FIELDS: ReadonlyArray<{ value: string; label: string }> = [
  ...
  { value: "gradeSectionId", label: "Class or grade section (label like \"Class 8-A\" or reference)" },
