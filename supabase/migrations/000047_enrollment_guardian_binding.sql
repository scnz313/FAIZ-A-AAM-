...
-- =============================================================================
-- 000047 — Enrollment conversion guardian-binding forward fix
--
-- Guarantees in ONE transaction: create/match the guardian record, bind the
-- existing applicant account/person, add exactly one Guardian grant and
-- verified contact/link, and remain idempotent. Never creates a second
-- account for the same applicant guardian.
-- =============================================================================
...
begin
  ...
  -- Idempotency: a retry returns the stored conversion result exactly once.
  ...
  -- Fresh create path: student + enrollment + guardian binding in ONE transaction.
  ...
  -- Guardian binding: create-or-match the guardian record on the applicant's
  -- person, grant Guardian exactly once, and record the verified link.
